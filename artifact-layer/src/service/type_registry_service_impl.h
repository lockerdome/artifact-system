...
class TypeRegistryServiceImpl final : public TypeRegistryService::Service {
 public:
  ...
  grpc::Status RegisterTypeVersion(
      grpc::ServerContext* context,
      const RegisterTypeVersionRequest* request,
      RegisterTypeVersionResponse* response) override;

  grpc::Status GetTypeVersion(
      grpc::ServerContext* context,
      const GetTypeVersionRequest* request,
      GetTypeVersionResponse* response) override;

  grpc::Status ListTypeVersions(
      grpc::ServerContext* context,
      const ListTypeVersionsRequest* request,
      ListTypeVersionsResponse* response) override;

  grpc::Status GetIndexSchema(
      grpc::ServerContext* context,
      const GetIndexSchemaRequest* request,
      GetIndexSchemaResponse* response) override;
